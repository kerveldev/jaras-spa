        ...
        <div className="min-h-screen flex flex-col bg-[#f8fafc]">
            ...
            <main className="flex flex-col md:flex-row gap-8 max-w-7xl w-full mx-auto px-4 pb-12 flex-1 pt-12">
                <section className="flex-1">
                    <h2 className="text-2xl font-titles mb-4 text-[#B7804F]">Servicio de transporte</h2>
                ...
                <aside className="w-full md:w-80">
                    <div className="bg-white border rounded-lg p-6 shadow-sm mb-6">
                        <h4 className="font-headers mb-3 text-[#B7804F]">Resumen de reserva</h4>
                        ...
                        {!paid && metodoPago === "tarjeta" && (
                            <form
                                ...
                                autoComplete="off"
                            >
                                <h5 className="font-headers mb-2 text-[#B7804F]">Paga con tarjeta</h5>
                                <input
                                ...
                                <div className="text-legal text-gray-400 mt-1">
                        ...
                        <div className="text-legal text-gray-500 mt-4 text-center">
                            Pago 100% seguro
                        </div>
                    </div>
                </aside>
