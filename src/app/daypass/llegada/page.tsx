    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#f8fafc]">
            ...
            <main className="max-w-6xl w-full mx-auto px-4 py-10 flex-1">
                ...
                <div className="mb-8">
                    <h2 className="text-2xl font-titles mb-2 text-[#B7804F]">Instrucciones de Llegada a la Estación</h2>
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <aside className="w-full md:w-80">
                        ...
                        {/* Detalles del viaje */}
                        <div className="bg-white border rounded-lg p-6 shadow-sm mb-8">
                            <div className="font-headers mb-2 text-sm text-[#B7804F]">Detalles del Viaje</div>
                        ...
                        <div className="bg-white border rounded-lg p-6 shadow-sm">
                            <div className="font-headers mb-2 text-sm text-[#B7804F]">¿Necesita Ayuda?</div>
