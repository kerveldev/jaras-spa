    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#f8fafc]">
            ...
            <main className="max-w-5xl w-full mx-auto px-4 py-12 flex-1">
                <h2 className="text-2xl font-titles mb-2 text-[#B7804F]">Agregar Crédito al Brazalete</h2>                <p className="mb-8 text-black">
                ...
                <div className="flex gap-4 mb-8">
                    <button
                        ...
                        onClick={() => setTipo("spa")}
                    >
                        <span className="font-headers mb-1 text-[#B7804F]">Crédito para Spa</span>
                    ...
                    >
                        <span className="font-headers mb-1 text-[#B7804F]">Crédito para Souvenirs</span>
                ...
                <form className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <aside className="w-full md:w-72">
                        <div className="bg-white border rounded-lg p-6 shadow-sm mb-4">
                            <h4 className="font-headers mb-3 text-[#B7804F]">Resumen</h4>
                ...
                <section className="mt-16">
                    <h3 className="font-titles text-lg mb-4 text-[#B7804F]">Servicios disponibles con crédito de Spa</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {serviciosSpa.map((s) => (
                            <div key={s.nombre} className="bg-white border rounded-lg p-6 flex flex-col items-start">
                                <div className="font-headers mb-1 text-[#B7804F]">{s.nombre}</div>
